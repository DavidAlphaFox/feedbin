module Settings
  class ControlRowComponent < ApplicationComponent
    ...
    def template
      div class: "py-4 flex items-center gap-4 group group-data-[capsule=true]:px-4 group-data-[item-capsule=true]:px-4 group-data-[item-capsule=true]:rounded-lg group-data-[item-capsule=true]:border group-data-[item-capsule=true]:pg-checked:border-blue-600 group-data-[item-capsule=true]:pg-checked:shadow-selected" do
        if content?
