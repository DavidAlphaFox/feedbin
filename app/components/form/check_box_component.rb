class Form::CheckBoxComponent < BaseComponent
  def call
    content_tag :span, class: "w-[16px] h-[16px] flex rounded-[3px] shadow-one relative border border-400 transition pg-checked:bg-blue-600 pg-checked:border-blue-600 pg-active:bg-300 pg-active:border-500 pg-checked:pg-active:bg-blue-700 pg-checked:pg-active:border-blue-700 pg-disabled:bg-300 pg-disabled:border-300 pg-disabled:pg-active:bg-300 pg-disabled:pg-active:border-300 pg-focus:shadow-none" do
